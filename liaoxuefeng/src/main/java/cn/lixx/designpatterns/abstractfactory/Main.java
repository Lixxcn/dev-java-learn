...
/**
 * Learn Java from
 * https://liaoxuefeng.com/books/java/design-patterns/creational/abstract-factory/index.html
 * 
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		fastHtml.save(
				Paths.get("./liaoxuefeng/src/main/java/cn/lixx/designpatterns/abstractfactory/output", "fast.html"));
		WordDocument fastWord = fastFactory.createWord("#Hello\nHello, world!");
		fastWord.save(
				Paths.get("./liaoxuefeng/src/main/java/cn/lixx/designpatterns/abstractfactory/output", "fast.doc"));
		...
		goodHtml.save(
				Paths.get("./liaoxuefeng/src/main/java/cn/lixx/designpatterns/abstractfactory/output", "good.html"));
		WordDocument goodWord = goodFactory.createWord("#Hello\nHello, world!");
		goodWord.save(
				Paths.get("./liaoxuefeng/src/main/java/cn/lixx/designpatterns/abstractfactory/output", "good.doc"));
	}
}
